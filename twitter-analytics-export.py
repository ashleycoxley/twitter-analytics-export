...
def get_tweet_data(session, start_time, end_time, user_agent):
    ...
    export_url = "https://analytics.twitter.com/user/ashleycoxley/tweets/export.json"
    bundle_url = "https://analytics.twitter.com/user/ashleycoxley/tweets/bundle"
...
if __name__ == '__main__':
    ...
    pw = 'twINge45'
    no_days = 60
    f_path = '/Users/ashley.cox/Desktop/'
